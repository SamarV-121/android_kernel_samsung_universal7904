...
#include "s6e8fc0_a40_param.h"
#include "dd.h"

#if defined(CONFIG_EXYNOS_DECON_MDNIE)
#include "mdnie.h"
#include "s6e8fc0_a40_mdnie.h"
#endif
...
static int s6e8fc0_init(struct lcd_info *lcd)
{
	...
	/* Table 3 VFP 24h */
	DSI_WRITE(SEQ_GLB_PARAM_2, ARRAY_SIZE(SEQ_GLB_PARAM_2));
	DSI_WRITE(SEQ_VFP, ARRAY_SIZE(SEQ_VFP));
	DSI_WRITE(SEQ_GLB_PARAM_3, ARRAY_SIZE(SEQ_GLB_PARAM_3));
	DSI_WRITE(SEQ_LTPS1, ARRAY_SIZE(SEQ_LTPS1));
	DSI_WRITE(SEQ_GLB_PARAM_4, ARRAY_SIZE(SEQ_GLB_PARAM_4));
	DSI_WRITE(SEQ_LTPS2, ARRAY_SIZE(SEQ_LTPS2));
	DSI_WRITE(SEQ_LTPS_UPDATE, ARRAY_SIZE(SEQ_LTPS_UPDATE));

	/* Table 4 Edge Dimming*/
	DSI_WRITE(SEQ_EDGE_DIMMING, ARRAY_SIZE(SEQ_EDGE_DIMMING));

	/* Table 5 Dim speed*/
	DSI_WRITE(SEQ_GLB_PARAM_5, ARRAY_SIZE(SEQ_GLB_PARAM_5));
	DSI_WRITE(SEQ_DIM_SPEED, ARRAY_SIZE(SEQ_DIM_SPEED));

...
static struct fimc_is_sensor_cfg config_module_5e9[] = {
	...
	/* 1296x972@60fps */
	FIMC_IS_SENSOR_CFG(1296,  972,  60, 19, 10, CSI_DATA_LANES_2),
	/* 2576x1932@30fps */
	FIMC_IS_SENSOR_CFG(2576, 1932,  30, 19, 11, CSI_DATA_LANES_2),
	/* 2576x1188@30fps */
	FIMC_IS_SENSOR_CFG(2576, 1188,  30, 19, 12, CSI_DATA_LANES_2),
	/* 2560x1600@30fps */
	FIMC_IS_SENSOR_CFG(2560, 1600,  30, 19, 13, CSI_DATA_LANES_2),
	/* 2560x1440@30fps */
	FIMC_IS_SENSOR_CFG(2560, 1440,  30, 19, 14, CSI_DATA_LANES_2),
	/* 2224x1080@30fps */
	FIMC_IS_SENSOR_CFG(2224, 1080,  30, 19, 15, CSI_DATA_LANES_2),
	/* 1920x1920@30fps */
	FIMC_IS_SENSOR_CFG(1920, 1920,  30, 19, 16, CSI_DATA_LANES_2),
	/* 1920x1080@30fps */
	FIMC_IS_SENSOR_CFG(1920, 1080,  30, 19, 17, CSI_DATA_LANES_2),
	/* 1280x960@30fps */
	FIMC_IS_SENSOR_CFG(1280,  960,  30, 19, 18, CSI_DATA_LANES_2),
	/* 1280x720@30fps */
	FIMC_IS_SENSOR_CFG(1280,  720,  30, 19, 19, CSI_DATA_LANES_2),
	/* 960x960@30fps */
	FIMC_IS_SENSOR_CFG(960 ,  960,  30, 19, 20, CSI_DATA_LANES_2),
	/* 640x480@120fps */
	FIMC_IS_SENSOR_CFG(640 ,  480, 120, 19, 21, CSI_DATA_LANES_2),
};
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	if (!gpio_is_valid(gpio_cam_1p2_en)) {
		dev_warn(dev, "failed to get gpio_cam_1p2_en\n");
	} else {
	...
	if (gpio_is_valid(gpio_cam_1p2_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_cam_1p2_en, "gpio_cam_1p2_en", PIN_OUTPUT, 1, 0);
	} else {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "RCAM2_DVDD_1P2", PIN_REGULATOR, 1, 500);
	}

	if (gpio_is_valid(gpio_cam_a2p8_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_cam_a2p8_en, "gpio_cam_a2p8_en", PIN_OUTPUT, 1, 0);
	} else {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "RCAM2_AVDD_2P8", PIN_REGULATOR, 1, 500);
	}

	if (gpio_is_valid(gpio_camio_1p8_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_camio_1p8_en, "gpio_camio_1p8_en", PIN_OUTPUT, 1, 0);
	} else {
	...
	if (gpio_is_valid(gpio_camio_1p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "CAM_VDDIO_1P8", PIN_REGULATOR, 0, 500);
	}

	if (gpio_is_valid(gpio_cam_a2p8_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_cam_a2p8_en, "gpio_cam_a2p8_en", PIN_OUTPUT, 0, 0);
	} else {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "RCAM2_AVDD_2P8", PIN_REGULATOR, 0, 500);
	}

	if (gpio_is_valid(gpio_cam_1p2_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_cam_1p2_en, "gpio_cam_1p2_en", PIN_OUTPUT, 0, 0);
	} else {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "RCAM2_DVDD_1P2", PIN_REGULATOR, 0, 500);
	}
	...
	if (gpio_is_valid(gpio_camio_1p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "CAM_VDDIO_1P8", PIN_REGULATOR, 0, 500);
	}
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	if (gpio_is_valid(gpio_cam_1p2_cam_a2p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "FCAM_AVDD_2P8", PIN_REGULATOR, 1, 0);	//LDO07
	}
#else
	if (gpio_is_valid(gpio_cam_core_en)) {
	...
	if (gpio_is_valid(gpio_camio_1p8_en)) {
		...
		//SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "FCAM_AVDD_2P8", PIN_REGULATOR, 1, 0);	//LDO03
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "CAM_VDDIO_1P8", PIN_REGULATOR, 1, 500);	//LDO03
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "FCAM_DVDD_1P2", PIN_REGULATOR, 1, 0);	//LDO04
	}
	...
	if (gpio_is_valid(gpio_camio_1p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "CAM_VDDIO_1P8", PIN_REGULATOR, 0, 0); //LDO03
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "FCAM_DVDD_1P2", PIN_REGULATOR, 0, 0); //LDO04
	}
	...
	if (gpio_is_valid(gpio_cam_1p2_cam_a2p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "FCAM_AVDD_2P8", PIN_REGULATOR, 0, 0);	//LDO07
	}
#else
	if (gpio_is_valid(gpio_cam_core_en)) {
	...
	if (gpio_is_valid(gpio_cam_1p2_cam_a2p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "FCAM_AVDD_2P8", PIN_REGULATOR, 1, 0);	//LDO07
	}
#else
	if (gpio_is_valid(gpio_cam_core_en)) {
	...
	if (gpio_is_valid(gpio_camio_1p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "CAM_VDDIO_1P8", PIN_REGULATOR, 1, 500);	//LDO03
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "FCAM_DVDD_1P2", PIN_REGULATOR, 1, 500);	//LDO04
	}
	...
	if (gpio_is_valid(gpio_cam_1p2_cam_a2p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "FCAM_AVDD_2P8", PIN_REGULATOR, 0, 0);	//LDO07
	}
#else
	if (gpio_is_valid(gpio_cam_core_en)) {
	...
	if (gpio_is_valid(gpio_camio_1p8_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "CAM_VDDIO_1P8", PIN_REGULATOR, 0, 0);	//ldO03
		SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "FCAM_DVDD_1P2", PIN_REGULATOR, 0, 0);	//ldO04
	}
